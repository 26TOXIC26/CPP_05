...
/*   Updated: 2025/02/22 05:27:48 by amousaid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm *ShrubberyCreationForm::CreateForm(std::string target, AForm *form, std::string name)
{
	if (name == "ShrubberyCreationForm" && form == NULL)
